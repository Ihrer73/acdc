...
struct Collision_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _entity_A_type;
  _entity_A_type entity_A;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _body_A_type;
  _body_A_type body_A;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _entity_B_type;
  ...
  _body_B_type body_B;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _magnitude_forces_type;
  _magnitude_forces_type magnitude_forces;

   typedef std::vector< ::flatland_msgs::Vector2_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::flatland_msgs::Vector2_<ContainerAllocator> >::other >  _contact_positions_type;
  _contact_positions_type contact_positions;

   typedef std::vector< ::flatland_msgs::Vector2_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::flatland_msgs::Vector2_<ContainerAllocator> >::other >  _contact_normals_type;
...
struct Printer< ::flatland_msgs::Collision_<ContainerAllocator> >
{
  ...
  {
    s << indent << "entity_A: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.entity_A);
    s << indent << "body_A: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.body_A);
    s << indent << "entity_B: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.entity_B);
    s << indent << "body_B: ";
