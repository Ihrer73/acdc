...
struct Collisions_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::flatland_msgs::Collision_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::flatland_msgs::Collision_<ContainerAllocator> >::other >  _collisions_type;
